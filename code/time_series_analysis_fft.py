...
data_wider = pd.read_csv(r'C:\Users\s1834371\Documents\PhD\SENSE_training\Bogs\code\ndvi_ndwi_wider_data.csv')
...
ax1.plot(date, ndwi, label='NDWI', color='b')
ax1.plot(date, ndvi, label='NDVI', color='limegreen', zorder=-1)
...
#ax2.text(x=pd.to_datetime('2019-05-09'), y=0.55, s='Wildfire (16th May 2019)', color='red')
